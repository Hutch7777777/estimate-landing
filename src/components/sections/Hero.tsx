...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-72px)] max-w-7xl flex-col items-center justify-center gap-12 px-6 py-16 lg:flex-row lg:items-center lg:gap-16 lg:px-8 lg:py-20">
            ...
            {stats.map((stat, index) => (
              <StaggerItem key={index}>
                <div className="flex flex-col">
                  <span className="font-mono text-2xl font-bold text-accent-primary sm:text-3xl md:text-4xl lg:text-5xl">
